            ...
            <div>
                <div className="level profile-level">
                    <div className="box profile-box">
                        ...
                        {percentCorrect <= 25 
                        ? QUIZ_RESULT_ANSWERS[3] 
                        : percentCorrect <= 50 
                            ? QUIZ_RESULT_ANSWERS[2] 
                            : percentCorrect <= 75 
                                ? QUIZ_RESULT_ANSWERS[1] 
                                : QUIZ_RESULT_ANSWERS[0]}
                        </h1>
                    </div>
                </div>
                <div className='level-item'>
                    <button className='button is-watermelon roboto-font' 
                            onClick={() => {this.props.changePageName(VIEW_SET)}}>
                            Return to Card Set
                    </button>
                </div>
            </div>
